...
int main() 
{
    ...
    Fl_Choice *choice = new Fl_Choice(150, 10, 100, 30, "Rodzaj arytmetyki:");
    choice->add("Rzeczywiste|Przedziałowe punktowe|Przedziałowe");


    Fl_Input *input_number_equations = new Fl_Input(150, 100, 200, 30, "Liczba równań:");
    Fl_Output *output = new Fl_Output(10, 1000, 200, 30, "Output:");
    Fl_Output *output_it = new Fl_Output(1200, 700, 200, 30, "Output it:");
    Fl_Button *btn_number_equations = new Fl_Button(400, 100, 100, 30, "Zapisz");
    Fl_Input *input_x = new Fl_Input(150, 200, 200, 30, "x[i]:");
    Fl_Input *inbut_xb = new Fl_Input(150, 240, 200, 30, "x[i].b:");
    Fl_Button *btn_x = new Fl_Button(400, 200, 100, 30, "Zapisz x[i]");
    Fl_Button *btn_calculate = new Fl_Button(700, 200, 100, 40, "Oblicz");
    Fl_Box *box_i = new Fl_Box(50, 350, 200, 30, "i = 0");
    Fl_Output *output_st = new Fl_Output(900, 700, 200, 30, "Output st:");
    Fl_Button *btn_reset = new Fl_Button(50, 400, 100, 40, "Reset");
    Fl_Text_Display *output_display = new Fl_Text_Display(900, 50, 600, 600, "Wynik:");
    Fl_Text_Buffer* textbuf = new Fl_Text_Buffer();
    output_display->buffer(textbuf);
    textbuf->text("");
    Fl_Widget* widgets[8] = {input_number_equations, output, output_it, input_x, inbut_xb, box_i, output_st, output_display};
